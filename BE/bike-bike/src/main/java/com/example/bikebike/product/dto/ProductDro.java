...
public class ProductDro implements Validator {
    ...
    public ProductDro(Long idProduct, String nameProduct, String codeProduct, Float price, String description, Boolean flagDeleted, Boolean flagNew, ImageDto imageDto, TypeProductDto typeProductDto, List<String> imageDtoList) {
        this.idProduct = idProduct;
        this.nameProduct = nameProduct;
        this.codeProduct = codeProduct;
        this.price = price;
